...
def get_action(player, history, opponent_history, score, opponent_score, getting_team_name=False):
    ...
    #
        ...
        if getting_team_name:
            ...
            # use history, opponent_history, score, opponent_score
            # to compute your strategy
            if len(opponent_history)==0: #It's the first round: backstab
                return 'b'
            else:
                return 'b' #the results are always backstabbing
    ...
    #
        ...
        if getting_team_name:
            return 'loyal and occasionally greedy'
        else:
            # use history, opponent_history, score, opponent_score
            # to compute your strategy
            if len(opponent_history)==0: #It's the first round: collude
                ...
                if random.random()<0.10:#30% of the the time they are greedy
                    return 'b'
                else:     
                    return 'c' #collude everytime#collude everytime
            else:
                return 'c'
